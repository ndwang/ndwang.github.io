...
toc:
  - name: AI for Scientific Computing
  - name: "From Fortran to Julia: Letting AI Do the Heavy Lift"
  - name: Hitting the Performance Wall
  - name: Measure, Optimize, Measure
  - name: AI Goes Brrrrr
  - name: The 1000x Speedup
  - name: Key Takeaways

# Custom styles to remove the title bar and match the example style
_styles: >
  d-title {
...
{% details Fortran vs Julia Translation Example %}
...
{% details deposit! Optimization Details %}
